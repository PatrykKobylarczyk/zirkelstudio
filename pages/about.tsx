...
const About = () => {
  ...
  return (
    <div className="py-24 w-full h-full grid place-items-center">
      <div className="flex flex-col px-5 md:flex-row md:w-[60vw] gap-16 md:gap-24 ">
        ...
        <div className="w-full md:w-7/12 flex flex-col gap-5 justify-center p-5">
          <h2 className="text-3xl font-bold">{lang.about_hello}</h2>
          <p>{lang.about_par1}</p>
          <p>{lang.about_par2}</p>
          <p>{lang.about_par3}</p>
          <p>{lang.about_par4}</p>
